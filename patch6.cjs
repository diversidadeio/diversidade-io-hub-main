...
// Update `select` query for socios
content = content.replace(/select\("empresa_id, nome, cpf, email, cep, data_nascimento, nacionalidade, raca, participacao_percentual, participacao_valor"\);/g, `select("empresa_id, nome, cpf, email, cep, data_nascimento, nacionalidade, raca, sexo, etariedade, participacao_percentual, participacao_valor");`);
